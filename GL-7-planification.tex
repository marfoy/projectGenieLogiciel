...
Kile (gratuit), \'editeur de texte pour les documents écrits en Latex. http://kile.sourceforge.net/ \newline
...
Tiled Map Editor (gratuit), outil ayant pour objectif de créer des cartes o\'u le joueur pourra se d\'eplacer (interface graphique). http://www.mapeditor.org/ \newline
...
\hline
2 : Livrable final non terminé ou incomplet. & \large{mod\'er\'ee} & \large{s\'erieuse} \\
\hline
3 : Code déffectueux & \Large{haute} &  \large{s\'erieuse} \\
\hline
4 : Probleme de compatibilité. & \large{mod\'er\'ee} &  \large{s\'erieuse} \\
\hline
5 : Abandon de la part d'un des collaborateur & basse &  \large{s\'erieuse} \\
\hline
6 : Code incomplet & \large{mod\'er\'ee} &  \large{s\'erieuse} \\
\hline
7 : Une des personnes est absente ou malade. & \Large{haute} &  tol\'erable \\
\hline
8 : Incomprehension d'un probleme & \large{haute} & tol\'erable \\
\hline
9 : Problemes d'horraire ou de communication & \Large{haute} &  tol\'erable \\
\hline
\end{tabular}
\end{center}
...
\hline
Diagramme d'états & 8 & Moyen & 05/11/14 &  05/11/14 & 0 & 0 \\
\hline
Diagramme de séquences & 7 & Moyen & 15/11/14 & 15/11/14 & 0 & 0 \\
\hline
Maquette de l'interface & 31 & Eleve & 14/10/14 & 14/10/14 & 0 & 0 \\
\hline
Rapport de moédélisation & 5 & Moyen & 26/11/14 & 26/11/14 & 0 & 0 \\
\hline
...
\emph{Expliquez \'Žgalement comment vous comptez surveiller les risques.}
