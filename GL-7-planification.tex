...
%%\emph{Quelles machines seront utilis\'ees? Pr\'excisez les caract\'Žristiques de chaque mat\'eriel: le nom, le co\^ut, le plateforme d'exploitation, le m\'empire, le processeur, le disque dur ou SSD, \ldots}
...
%%\emph{Les machines de d\'eveloppement seront-elles diff\'erentes des machines de d\'eploiement? Si cÕest le cas,  d\'ecrivez les caract\'eristiques de chacun.}
...
Le tableau ci-dessous rassemble les différentes solutions à la gestion des risques cit\'es au point pr\'ec\'dent.
...
\hline\hline
1 & Utilisation d'un gestionnaire de versions & Comparer notre code avec le code d'un autre collaborateur & Récuperer le code d'un autre collaborateur\\
\hline
2 & V\'erifier avant l'envoi si le livrable est complet & Relire l'\'enonc\'e et regarder si tout appara\^it dans le livrable & Si le d\'elai n'est pas pass\'e, envoyer une nouvelle version compl\`ete\\
\hline
...
\hline
4 & Tester le code sur plusieurs environnements  & Demander \`a un collaborateur qui utilise un autre environnement de tester le code & Rep\'erer les endroits non compatibles et les rendre plus g\'en\'eriques\\
\hline
5 & Conna\^itre le travail effectu\'e par chaque membre et savoir comment bien le r\'epartir & Envoi d'un email au membre & R\'epartir le travail du membre qui a abandonn\'e entre les autres membres\\
\hline
...
\hline
7 & Conna\^itre le travail effectu\'e par chaque membre et savoir comment bien le r\'epartir & Envoi d'un email au membre & R\'epartir le travail du membre qui est absent entre les autres membres\\
\hline
8 & Am\'eliorer son niveau d'anglais & Essayer de comprendre la documentation sur internet & Faire une demande d'aide sur un forum francophone\\
\hline
9 & Reunion et organisation au sein du groupe pour fixer des horraires & Demander a toutes les personnes d'\^etre pr\'esentes & Report \`a une date ult\'erieure\\
\hline
\end{tabular}
\end{center}
...
\includegraphics[width=\textwidth]{Gantt1.png}
  \caption{Diagramme Gantt de la phase 2.}\label{fig:Phase 1}
\end{center}
\end{figure}
...
\includegraphics[width=\textwidth]{Gantt2.png}
  \caption{Diagramme Gantt de la phase 3.}\label{fig:Phase 2}
\end{center}
\end{figure}
...
\includegraphics[width=\textwidth]{PERT1.PNG}
  \caption{Diagramme PERT de la phase 2.}\label{fig:PERT1}
\end{center}
\end{figure}
...
\includegraphics[width=\textwidth]{PERT2.PNG}
  \caption{Diagramme PERT de la phase 3.}\label{fig:PERT2}
\end{center}
\end{figure}
...
\hline
Diagramme d'états & 8 & 11.25 p/m & 05/11/14 &  05/11/14 & 0 & 0 \\
\hline
Diagramme de séquences & 7 & 12.9 p/m & 15/11/14 & 15/11/14 & 0 & 0 \\
\hline
Maquette de l'interface & 31 & 3 p/m & 14/10/14 & 14/10/14 & 0 & 0 \\
\hline
Rapport de moédélisation & 5 & 18 p/m & 26/11/14 & 26/11/14 & 0 & 0 \\
\hline
...
Sur les diagrammes PERT, on peut voir que le chemin critique est indiqu\'e car la phase 2 dure 7 semaines et la phase 3 dure 16 semaines ce qui nous donne
...
En cours de projet, pour v\'erifier si un retard peut arriver, nous allons comparer le pourcentage de la t\^ache termin\'ee par rapport 
au temps restant. 
...
\smallskip En ce qui concerne les risques, nous essaierons au maximum d'appliquer la gestion des risques d\'ecrite dans le tableau de gestions des risques. (Table : \ref{tab:GestionRisques}, page : \pageref{tab:GestionRisques})
