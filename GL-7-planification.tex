...
\begin{figure}[!htb]
\begin{center}
\includegraphics{repartition.PNG}
...
\hline
30 novembre 2014 & Date de remise pour la phase 2 &\scriptsize Rapport de mod\'elisation et maquette de
l'interface utilisateur.\normalsize \\
\hline
...
\includegraphics[width=16CM]{PERT.PNG}
  \caption{Diagramme de PERT de la phase 1.}\label{fig:PERT}
\end{center}
\end{figure}
...
\includegraphics[width=25cm]{PERT4.PNG}
  \caption{Diagramme de PERT de la phase 2.}\label{fig:PERT2}
\end{center}
\end{figure}
