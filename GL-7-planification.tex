...
\item Kile (gratuit), \'editeur de texte pour les documents écrits en Latex. http://kile.sourceforge.net/ \newline
...
\item Tiled Map Editor (gratuit), outil ayant pour objectif de créer des cartes o\'u le joueur pourra se d\'eplacer (interface graphique). http://www.mapeditor.org/ \newline
