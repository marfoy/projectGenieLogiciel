...
\author{Groupe num\'ero: \textbf{XX}\\
Membres du groupe: \textbf{NOMS+PRENOMS}}
%
...
\begin{abstract}
Ce \emph{rapport de ...} est rendu dans le cadre du cours ``Projet de G\'enie Logiciel" (dispens\'e par le Prof. \emph{Tom Mens} en ann\'ee acad\'emique ****-****). Le but de ce rapport est de ... COMPLETEZ LE RESUME ICI.
\end{abstract}
...
\emph{Quels sont le contexte et les objectifs du projet de g\'enie logiciel?}

Le travail s'inscrit dans le cadre de \ldots

Le travail consiste \`a \ldots
...
nom & r\^ole & dur\'ee & responsabilit\'e & pourcentage du temps & ... \\
\hline
... & & & & \\
... & & & & \\
\end{tabular}
...
\emph{Quels logiciels seront utilis\'es et pourquoi? Pr\'excisez les caract\'éristiques de chaque logiciel: son nom, son co\^ut, sa version, son utilit\'e, son type de licence, \ldots.}
...
\emph{Quelles machines seront utilis\'ees? Pr\'excisez les caract\'éristiques de chaque mat\'eriel: le nom, le co\^ut, le plateforme d'exploitation, le m\'empire, le processeur, le disque dur ou SSD, \ldots}
...
\emph{Expliquez \'également comment vous comptez surveiller les risques.}
